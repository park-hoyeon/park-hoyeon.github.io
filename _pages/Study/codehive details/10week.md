...
안녕하세요. 소시지입니다.<br>
본 포스팅은 <2024.09.23 ~ 2024.12.09> 기간의 코딩 스터디 10주차 학습 내용을 기록했습니다.

## `CodeHive Study` 10주차 진행 (2024.12.02)

### 🗓️ 학습 주제

1. 그동안 공부했던 데이터를 저장하고 이용할 수 있는 간단한 웹 서버(Django) 팀원 모두 함께 협업하여 제작<br>
2. 게시판, 글 작성 기능, 글 수정 기능, 글 삭제 기능, 글 조회 기능 구현<br>
3. 게시판 외에 팀 내에서 얻은 데이터들을 업로드 할 수 있는 공간 제작<br>
